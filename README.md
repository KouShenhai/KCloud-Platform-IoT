...
<a href="https://github.com/KouShenhai/KCloud-Platform-IoT/actions/workflows/go.yml" target="_blank"><img src="https://github.com/KouShenhai/KCloud-Platform-IoT/actions/workflows/go.yml/badge.svg?branch=master" alt="Go CI Build Stauts"/></a>
...
<a href="https://spring.io/projects/spring-framework" target="_blank"><img src="https://img.shields.io/static/v1?label=Spring%20Framework&message=7.0.8&color=green" alt="Spring Framework"/></a>
<a href="https://spring.io/projects/spring-authorization-server" target="_blank"><img src="https://img.shields.io/static/v1?label=Spring%20Security&message=7.1.0&color=green" alt="Spring Security"/></a>
<a href="https://spring.io/projects/spring-boot" target="_blank"><img src="https://img.shields.io/static/v1?label=Spring%20Boot&message=4.1.0&color=green" alt="Spring Boot"/></a>
<a href="https://spring.io/projects/spring-cloud" target="_blank"><img src="https://img.shields.io/static/v1?label=Spring%20Cloud&message=2025.1.2&color=green" alt="Spring Cloud"/></a>
...
| ![国际化菜单](doc/image/project/11.png) | ![API文档](doc/image/project/12.png)  |
| ![数据字典](doc/image/project/13.png)  |                                     |
...
[开发计划（需要登录）](https://docs.qq.com/sheet/DUGhCdGVZWmVxT0VJ)
...
<div style="text-align: center"><img src="doc/image/老寇IoT云平台业务架构图.png" alt="架构图"/></div>
...
- 采用 Apache2.0和MIT双协议，任选其一，请保留作者、Copyright信息【免费用于毕设、二开、商用、二次开源】
- 采用 Apache2.0和MIT双协议，任选其一，请保留作者、Copyright信息【免费用于毕设、二开、商用、二次开源】
- 采用 Apache2.0和MIT双协议，任选其一，请保留作者、Copyright信息【免费用于毕设、二开、商用、二次开源】

### 😻 开源协议（删除版权协议可联系作者购买，否则需要保留版权协议）

- KCloud-Platform-IoT 开源软件遵循 [Apache 2.0 协议](https://www.apache.org/licenses/LICENSE-2.0.html) 请务必保留作者、Copyright信息
- KCloud-Platform-IoT 开源软件遵循 [MIT 协议](https://opensource.org/licenses/MIT) 请务必保留作者、Copyright信息
