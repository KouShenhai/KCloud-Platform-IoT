...
KCloud-Platform-Alibaba（老寇云平台）是一款企业级微服务架构的云服务平台。基于Spring Boot 3.0.3、Spring Cloud 2022.0.1、Spring Cloud Alibaba 2022.0.0.0-RC1 最新版本开发的多租户SaaS系统。
...
<p align="center">
    ...
    <a target="_blank" href="https://spring.io/projects/spring-boot"><img src="https://img.shields.io/static/v1?label=Spring Boot&message=3.0.3&color=green" alt="SpringBoot"></a>
...
🚀 资源管理：视频、图片、音频信息增删改查，资源审批（分布式事务AT模式），审批日志，数据同步（批量同步到ES）（默认数据库）          
