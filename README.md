...
KCloud-Platform-Alibaba（老寇云平台）是一个企业级微服务架构的云服务平台。基于Spring Boot 3.1.5、Spring Cloud 2022.0.4、Spring Cloud Alibaba 2022.0.0.0 最新版本开发的多租户SaaS系统。
...
<p align="center">
    ...
    <a target="_blank" href="https://spring.io/projects/spring-boot"><img src="https://img.shields.io/static/v1?label=Spring Boot&message=3.1.5&color=green" alt="SpringBoot"></a>
...
🚀 代码生成器：自定义模板生成代码  
🚀 资源管理：资源信息管理增删改查，（审批 + 处理 + 转办 + 委派 => Seata AT模式），审批日志，同步（批量同步到ES）（默认数据库）          
...
<table>
    ...
    <tr>
        <td>学生</td>
        <td>￥ 199</td>
        <td>项目演示 + 视频教程（筹划中） + 解决问题（优先） + 一对一售后群 + 个性功能增强（需提供学生证）</td>
    </tr>
    <tr>
        <td>个人</td>
        <td>￥ 399</td>
