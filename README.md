...
### 🔎 功能介绍
🚀 用户登录：账号密码（多租户）、手机号、邮件、授权码登录   
🚀 用户管理：用户信息新增、删除、修改、查询（字段共享）（可重置密码）   
🚀 角色管理：角色信息新增、删除、修改、查询；基于部门的数据权限、角色权限（字段共享）     
🚀 菜单管理：菜单信息新增、删除、修改、查询（字段共享）（自定义菜单图标）   
🚀 部门管理：部门信息新增、删除、修改、查询（字段共享）    
🚀 日志管理：操作日志（字段共享）、登录日志（独立数据库）查询、导出    
🚀 字典管理：字典信息管理（独立数据库）    
🚀 消息管理：消息提醒和消息通知（独立数据库）    
🚀 搜索管理：通过关键字搜索并高亮显示（默认ES）    
🚀 流程定义：流程定义、挂起、激活、查看、删除（默认库）    
🚀 接口文档：Swagger2升级为Open Api Doc 3    
🚀 服务监控：服务内存监控及报警     
🚀 缓存监控：Redis内存监控    
🚀 主机监控：服务器内存或磁盘监控    
🚀 存储管理：存储信息新增、删除、修改、查询，兼容Amazon S3（独立数据库）  （页面需要绘制）     
🚀 邮件管理：邮件信息新增、删除、修改、查询（独立数据库）    （开发中）     
🚀 模板管理：模板信息新增、删除、修改、查询（独立数据库）    （开发中）    
🚀 短信管理：短信信息新增、删除、修改、查询（独立数据库）    （开发中）     
🚀 租户管理：租户信息新增、删除、修改、查询（默认数据库）    （绘制页面中）     
🚀 数据源管理：数据源信息新增、删除、修改、查询（默认数据库）      
🚀 资源管理：视频、图片、音频信息新增、删除、修改、查询；资源审批（分布式事务AT模式）；审批日志；数据同步（批量同步到ES）（独立数据库）       
