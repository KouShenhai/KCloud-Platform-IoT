...
<p align="center">
    ...
    <a target="_blank" href="https://github.com/KouShenhai/KCloud-Platform-Alibaba"><img alt="GitHub Stars" src="https://img.shields.io/github/stars/KouShenhai/KCloud-Platform-Alibaba"></a>
    <a target="_blank" href="https://github.com/KouShenhai/KCloud-Platform-Alibaba"><img alt="GitHub Forks" src="https://img.shields.io/github/forks/KouShenhai/KCloud-Platform-Alibaba"></a>
...
🚀 角色管理：角色信息增删改查，基于部门的数据权限、角色权限（字段共享）     
🚀 菜单管理：菜单信息增删改查（字段共享）（自定义菜单图标）   
🚀 部门管理：部门信息增删改查（字段共享）    
🚀 日志管理：操作日志、登录日志查询、导出（字段共享）       
🚀 字典管理：字典信息管理（独立数据库）    
🚀 消息管理：消息提醒和消息通知（独立数据库）    
...
🚀 缓存监控：Redis内存监控    
🚀 主机监控：服务器内存或磁盘监控    
🚀 存储管理：存储信息增删改查，兼容Amazon S3（独立数据库）    
🚀 租户管理：租户信息增删改查增删改查（默认数据库）       
🚀 套餐管理：自定义租户菜单增删改查（默认数据库）    
🚀 数据源管理：数据源信息增删改查（默认数据库）         
🚀 资源管理：视频、图片、音频信息增删改查，资源审批（分布式事务AT模式），审批日志，数据同步（批量同步到ES）（独立数据库）          
