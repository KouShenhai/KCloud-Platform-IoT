...
- [x] 用户管理：用户信息新增、删除、修改、查询（字段共享）（可重置密码）
- [x] 角色管理：角色信息新增、删除、修改、查询；基于部门的数据权限、角色权限（字段共享）  
- [x] 菜单管理：菜单信息新增、删除、修改、查询（字段共享）（自定义菜单图标）
- [x] 部门管理：部门信息新增、删除、修改、查询（字段共享）
- [x] 日志管理：操作日志（字段共享）、登录日志（独立数据库）查询、导出
- [x] 字典管理：字典信息管理（独立数据库）
- [x] 消息管理：消息提醒和消息通知（独立数据库）
- [x] 搜索管理：通过关键字搜索并高亮显示（默认ES）
- [x] 资源管理：视频、图片、音频信息新增、删除、修改、查询；资源审批（分布式事务AT模式）；审批日志；数据同步（批量同步到ES）（独立数据库）
- [x] 流程定义：流程定义、挂起、激活、查看、删除（默认库）
- [x] 接口文档：Swagger2升级为Open Api Doc 3
- [x] 服务监控：服务内存监控及报警
- [x] 缓存监控：Redis内存监控
- [x] 主机监控：服务器内存或磁盘监控
- [ ] 租户管理：租户信息新增、删除、修改、查询（默认数据库）
- [x] 数据源管理：数据源信息新增、删除、修改、查询（默认数据库）
- [ ] 存储管理：存储信息新增、删除、修改、查询，兼容Amazon S3（独立数据库）
- [ ] 邮件管理：邮件信息新增、删除、修改、查询（独立数据库）
- [ ] 模板管理：模板信息新增、删除、修改、查询（独立数据库）
- [ ] 短信管理：短信信息新增、删除、修改、查询（独立数据库）
- [ ] 微信公众号管理：微信公众号一体化管理
- [ ] 统计报表：用户画像
