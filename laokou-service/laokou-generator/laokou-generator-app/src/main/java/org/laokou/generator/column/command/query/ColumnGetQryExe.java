...
public class ColumnGetQryExe {

	private final ColumnMapper columnMapper;

	public Result<ColumnCO> execute(ColumnGetQry qry) {
		return Result.ok(ColumnConvertor.toClientObject(columnMapper.selectById(qry.getId())));
	}
