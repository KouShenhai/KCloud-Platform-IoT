...
public class TemplateGetQryExe {

	private final TemplateMapper templateMapper;

	public Result<TemplateCO> execute(TemplateGetQry qry) {
		return Result.ok(TemplateConvertor.toClientObject(templateMapper.selectById(qry.getId())));
	}
