...
public class CreateTable {
	...
	private static final String URL = "jdbc:mysql://192.168.30.128:3306/?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=Asia/Shanghai&useSSL=false";
	...
	public static void main(String[] args) {
		List<String> tableList = List.of("kcloud_platform_alibaba", "kcloud_platform_alibaba_flowable",
				"kcloud_platform_alibaba_nacos", "kcloud_platform_alibaba_tenant", "kcloud_platform_alibaba_user_0",
				"kcloud_platform_alibaba_user_1", "kcloud_platform_alibaba_xxl_job", "kcloud_platform_alibaba_seata");
