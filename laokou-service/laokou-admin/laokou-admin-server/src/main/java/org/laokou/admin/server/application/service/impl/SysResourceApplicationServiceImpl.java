...
//		// 将资源审批表的信息写入资源表
//		LambdaQueryWrapper<SysResourceAuditDO> queryWrapper = Wrappers.lambdaQuery(SysResourceAuditDO.class)
//				.eq(SysResourceAuditDO::getProcessInstanceId, instanceId)
//				.eq(SysResourceAuditDO::getResourceId, businessId)
//				.select(SysResourceAuditDO::getUrl, SysResourceAuditDO::getTitle, SysResourceAuditDO::getRemark);
...
//				.set(SysResourceDO::getVersion, version + 1).set(SysResourceDO::getTitle, auditDO.getTitle())
//				.set(SysResourceDO::getRemark, auditDO.getRemark()).set(SysResourceDO::getUrl, auditDO.getUrl());
...
//				.set(SysResourceAuditDO::getStatus, status).set(SysResourceAuditDO::getVersion, version + 1)
//				.eq(SysResourceAuditDO::getVersion, version).eq(SysResourceAuditDO::getProcessInstanceId, instanceId);
