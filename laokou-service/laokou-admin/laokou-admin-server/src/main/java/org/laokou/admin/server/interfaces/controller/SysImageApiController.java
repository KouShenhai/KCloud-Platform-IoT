...
// return Result.of(sysResourceApplicationService.syncResource("image",
/// RedisKeyUtil.getSyncIndexKey("image")));
// }
//
// @TraceLog
// @PostMapping("/query")
...
// public void download(@RequestParam("id") Long id, HttpServletResponse response) throws
/// IOException {
...
// public Result<String> diagram(@RequestParam("processInstanceId") String
/// processInstanceId) throws IOException {
...
// public Result<List<SysAuditLogVO>> auditLog(@RequestParam("businessId") Long
/// businessId) {
