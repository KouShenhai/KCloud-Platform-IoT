...
// public Result<List<SysAuditLogVO>> auditLog(@PathVariable("businessId") Long
/// businessId) {
...
// return Result
// .of(sysResourceApplicationService.syncResource(AUDIO_CODE,
/// RedisKeyUtil.getSyncIndexKey(AUDIO_CODE)));
// }
//
