...
import org.laokou.admin.ip.dto.IpGetQry;
...
public class IpGetQryExe {

	private final IpMapper ipMapper;

	public Result<IpCO> execute(IpGetQry qry) {
		return Result.ok(IpConvertor.toClientObject(ipMapper.selectById(qry.getId())));
	}
