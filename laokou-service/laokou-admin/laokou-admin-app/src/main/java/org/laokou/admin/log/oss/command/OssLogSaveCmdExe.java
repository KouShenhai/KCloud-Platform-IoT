...
package org.laokou.admin.log.oss.command;

import lombok.RequiredArgsConstructor;
import org.laokou.admin.log.oss.ability.OssLogDomainService;
...
public class OssLogSaveCmdExe {
	...
	public void executeVoid(OssLogSaveCmd cmd) {
		// 校验参数
		transactionalUtils
			.executeInTransaction(() -> ossLogDomainService.createOssLog(OssLogConvertor.toEntity(cmd.getCo())));
	}
