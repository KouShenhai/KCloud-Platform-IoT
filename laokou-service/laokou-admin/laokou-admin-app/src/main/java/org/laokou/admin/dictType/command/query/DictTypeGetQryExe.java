...
import org.laokou.admin.dictType.dto.DictTypeGetQry;
...
public class DictTypeGetQryExe {

	private final DictTypeMapper dictTypeMapper;

	public Result<DictTypeCO> execute(DictTypeGetQry qry) {
		return Result.ok(DictTypeConvertor.toClientObject(dictTypeMapper.selectById(qry.getId())));
	}
