...
import org.laokou.admin.dictType.dto.DictTypeSaveCmd;
...
public class DictTypeSaveCmdExe {

	private final DictTypeDomainService dictTypeDomainService;

	public void executeVoid(DictTypeSaveCmd cmd) {
		// 校验参数
		dictTypeDomainService.create(DictTypeConvertor.toEntity(cmd.getCo()));
	}
