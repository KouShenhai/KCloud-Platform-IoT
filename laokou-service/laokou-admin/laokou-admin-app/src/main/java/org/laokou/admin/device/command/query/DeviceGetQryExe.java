...
import org.laokou.admin.device.dto.DeviceGetQry;
...
public class DeviceGetQryExe {

	private final DeviceMapper deviceMapper;

	public Result<DeviceCO> execute(DeviceGetQry qry) {
		return Result.ok(DeviceConvertor.toClientObject(deviceMapper.selectById(qry.getId())));
	}
