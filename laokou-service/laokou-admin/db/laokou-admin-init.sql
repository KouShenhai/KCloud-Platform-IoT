...
CREATE TABLE `boot_sys_message` (
  ...
  `send_status` tinyint(1) DEFAULT NULL COMMENT '发送状态：0等待发送 1发送中 2发送成功 3发送失败',
  `creator` bigint(20) DEFAULT NULL COMMENT '创建人',
  `editor` bigint(20) DEFAULT NULL COMMENT '编辑人',
  `create_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
...
INSERT INTO `boot_sys_menu` (`id`, `pid`, `permissions`, `type`, `name`, `url`, `auth_level`, `method`, `icon`, `creator`, `editor`, `create_date`, `update_date`, `del_flag`, `sort`) VALUES ('1547109188256260097', '1535878154046939137', 'sys:api:view', '0', '接口文档', 'http://175.178.69.253:5555/doc.html', '0', 'GET', 'row', '1341620898007281665', '1341620898007281665', '2022-07-13 14:43:01', '2022-07-13 14:43:01', '0', '400');
