...
INSERT INTO `boot_sys_menu` (`id`, `pid`, `permissions`, `type`, `name`, `url`, `auth_level`, `method`, `icon`, `creator`, `editor`, `create_date`, `update_date`, `del_flag`, `sort`) VALUES ('1549963210746126337', '1537447512825225218', 'monitor:druid:auth:view	', '0', '认证模块监控', 'http://175.178.69.253/laokou/auth/druid/login.html', '0', 'GET', 'password', '1341620898007281665', '1341620898007281665', '2022-07-21 11:43:36', '2022-07-21 11:43:36', '0', '900');
