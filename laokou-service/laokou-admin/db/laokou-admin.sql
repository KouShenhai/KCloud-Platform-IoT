...
INSERT INTO `boot_sys_menu` (`id`, `pid`, `permissions`, `type`, `name`, `url`, `auth_level`, `method`, `icon`, `creator`, `editor`, `create_date`, `update_date`, `del_flag`, `sort`) VALUES ('1541939565596508162', '0', 'sys:msg:view', '0', '系统消息', '/sys/msg/view', '0', 'GET', 'message', '1341620898007281665', '1341620898007281665', '2022-06-29 12:24:26', '2022-06-29 12:24:26', '0', '7000');
