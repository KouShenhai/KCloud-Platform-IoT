...
public class AuditLogEvent extends DomainEvent<Long> {
	...
	protected AuditLogEvent(Long aLong, Long aggregateId, EventType eventType, EventStatus eventStatus, String topic,
			String sourceName, String appName, Long creator, Long editor, Long deptId, String deptPath, Long tenantId,
