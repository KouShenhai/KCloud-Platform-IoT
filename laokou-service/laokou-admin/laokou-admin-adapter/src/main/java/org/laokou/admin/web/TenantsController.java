...
public class TenantsController {
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:tenant:save')")
	...
	@DataCache(name = NameConstants.TENANTS, key = "#cmd.co.id", operateType = OperateType.DEL)
	public void modifyTenant(@RequestBody TenantModifyCmd cmd) {
		tenantsServiceI.modifyTenant(cmd);
	}

	@DeleteMapping("/v1/tenants")
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:tenant:remove')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:tenant:import')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:tenant:export')")
	...
	@PreAuthorize("hasAuthority('read') and hasAuthority('sys:tenant:page')")
