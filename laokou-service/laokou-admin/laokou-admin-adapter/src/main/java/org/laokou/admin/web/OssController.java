...
public class OssController {
	...
	@Idempotent
	@PostMapping("/v1/oss")
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:oss:save')")
	...
	@PutMapping("/v1/oss")
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:oss:modify')")
	...
	@DeleteMapping
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:oss:remove')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:oss:import')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:oss:export')")
	...
	@PreAuthorize("hasAuthority('read') and hasAuthority('sys:oss:page')")
