...
public class OssLogsController {
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:oss-log:save')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:oss-log:modify')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:oss-log:remove')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:oss-log:import')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:oss-log:export')")
	...
	@PreAuthorize("hasAuthority('read') and hasAuthority('sys:oss-log:page')")
	...
	@PreAuthorize("hasAuthority('read') and hasAuthority('sys:oss-log:detail')")
	@Operation(summary = "查看OSS日志详情", description = "查看OSS日志详情")
	public Result<OssLogCO> getByIdOssLog(@PathVariable Long id) {
