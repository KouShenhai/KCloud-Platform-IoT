...
public class UsersController {
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:user:save')")
	...
	@Cache(name = NameConstants.USERS, key = "#cmd.co.id", operateType = OperateType.DEL)
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:user:import')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:user:export')")
	...
	@Cache(name = NameConstants.USERS, key = "#cmd.id", operateType = OperateType.DEL)
	...
	@Cache(name = NameConstants.USERS, key = "#id")
