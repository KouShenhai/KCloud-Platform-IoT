...
public class OperateLogsController {
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:operate-log:save')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:operate-log:modify')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:operate-log:remove')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:operate-log:import')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:operate-log:export')")
