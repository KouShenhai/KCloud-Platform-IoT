...
public class DeptsController {
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:dept:save')")
	...
	@PutMapping("/v1/depts")
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:dept:modify')")
	@OperateLog(module = "部门管理", operation = "修改部门")
	@Operation(summary = "修改部门", description = "修改部门")
	@Cache(name = NameConstants.DEPTS, key = "#cmd.co.id", operateType = OperateType.DEL)
	public void modifyDept(@RequestBody DeptModifyCmd cmd) {
		deptsServiceI.modifyDept(cmd);
	}

	@DeleteMapping("/v1/depts")
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:dept:remove')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:dept:import')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:dept:export')")
	...
	@Cache(name = NameConstants.DEPTS, key = "#id")
