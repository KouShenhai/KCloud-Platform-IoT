...
public class DictItemsController {
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:dict-item:save')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:dict-item:modify')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:dict-item:remove')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:dict-item:import')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:dict-item:export')")
	...
	@PreAuthorize("hasAuthority('read') and hasAuthority('sys:dict-item:page')")
	...
	@PreAuthorize("hasAuthority('read') and hasAuthority('sys:dict-item:detail')")
	@Operation(summary = "查看字典项详情", description = "查看字典项详情")
	public Result<DictItemCO> getDictItemById(@PathVariable Long id) {
