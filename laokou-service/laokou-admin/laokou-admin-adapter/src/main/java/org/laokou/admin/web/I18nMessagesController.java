...
import org.laokou.admin.i18nMessage.dto.I18nMessageExportCmd;
import org.laokou.admin.i18nMessage.dto.I18nMessageGetQry;
...
public class I18nMessagesController {
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:i18n-message:save')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:i18n-message:modify')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:i18n-message:remove')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:i18n-message:import')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:i18n-message:export')")
	...
	@PreAuthorize("hasAuthority('read') and hasAuthority('sys:i18n-message:page')")
	...
	@PreAuthorize("hasAuthority('read') and hasAuthority('sys:i18n-message:detail')")
