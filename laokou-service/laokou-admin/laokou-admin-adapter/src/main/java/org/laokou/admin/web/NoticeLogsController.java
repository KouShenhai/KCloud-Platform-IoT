...
public class NoticeLogsController {
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:notice-log:save')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:notice-log:modify')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:notice-log:remove')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:notice-log:import')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:notice-log:export')")
	...
	@PreAuthorize("hasAuthority('read') and hasAuthority('sys:notice-log:page')")
	...
	@PreAuthorize("hasAuthority('read') and hasAuthority('sys:notice-log:detail')")
	@Operation(summary = "查看通知日志详情", description = "查看通知日志详情")
	public Result<NoticeLogCO> getNoticeLogById(@PathVariable Long id) {
