...
public class ClustersController {
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:cluster:save')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:cluster:modify')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:cluster:remove')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:cluster:import')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:cluster:export')")
	...
	@PreAuthorize("hasAuthority('read') and hasAuthority('sys:cluster:page')")
	...
	@PreAuthorize("hasAuthority('read') and hasAuthority('sys:cluster:detail')")
	@Operation(summary = "查看集群详情", description = "查看集群详情")
	public Result<ClusterCO> getClusterById(@PathVariable Long id) {
