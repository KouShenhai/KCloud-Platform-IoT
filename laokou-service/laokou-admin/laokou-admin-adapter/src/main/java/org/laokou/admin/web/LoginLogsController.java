...
public class LoginLogsController {
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:login-log:save')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:login-log:modify')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:login-log:remove')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:login-log:import')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('sys:login-log:export')")
	...
	@PreAuthorize("hasAuthority('read') and hasAuthority('sys:login-log:page')")
