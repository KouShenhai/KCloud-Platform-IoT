...
package org.laokou.admin.dict.item.model;

import lombok.Getter;
import org.laokou.admin.dict.item.model.entity.DictItemE;
import org.laokou.admin.dict.item.model.validator.DictItemParamValidator;
import org.laokou.admin.menu.i18n.model.enums.OperateType;
...
public class DictItemA extends AggregateRoot implements ValidateName {
	...
	private final transient DictItemParamValidator saveDictItemParamValidator;

	private final transient DictItemParamValidator modifyDictItemParamValidator;
	...
	public void checkDictItemParam() {
		switch (operateType) {
