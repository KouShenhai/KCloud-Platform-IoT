...
public class UpAlarmEventDeviceMessageHandler implements MessageHandler {
	...
	public boolean isSubscribe(String topic) {
		return VertxMqttUtils.matchTopic(MqttMessageType.UP_ALARM_EVENT_DEVICE_MESSAGE.getTopic(), topic);
	}
