...
public class DownReadPropertiesGatewayMessageHandler implements MessageHandler {
	...
	public boolean isSubscribe(String topic) {
		return VertxMqttUtils.matchTopic(MqttMessageType.DOWN_READ_PROPERTIES_GATEWAY_MESSAGE.getTopic(), topic);
	}
