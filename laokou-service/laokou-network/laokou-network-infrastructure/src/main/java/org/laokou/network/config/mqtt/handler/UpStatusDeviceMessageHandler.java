...
public class UpStatusDeviceMessageHandler implements MessageHandler {
	...
	public boolean isSubscribe(String topic) {
		return VertxMqttUtils.matchTopic(MqttMessageType.UP_STATUS_DEVICE_MESSAGE.getTopic(), topic);
	}
