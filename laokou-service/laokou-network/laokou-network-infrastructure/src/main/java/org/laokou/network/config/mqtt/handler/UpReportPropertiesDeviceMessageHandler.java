...
public class UpReportPropertiesDeviceMessageHandler implements MessageHandler {
	...
	public boolean isSubscribe(String topic) {
		return VertxMqttUtils.matchTopic(MqttMessageType.UP_REPORT_PROPERTIES_DEVICE_MESSAGE.getTopic(), topic);
	}
