...
public class UpWritePropertiesReplyDeviceMessageHandler implements MessageHandler {
	...
	public boolean isSubscribe(String topic) {
		return VertxMqttUtils.matchTopic(MqttMessageType.UP_WRITE_PROPERTIES_REPLY_DEVICE_MESSAGE.getTopic(), topic);
	}
