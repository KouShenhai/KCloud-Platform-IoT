...
public class UpReadPropertiesReplyDeviceMessageHandler implements MessageHandler {
	...
	public boolean isSubscribe(String topic) {
		return VertxMqttUtils.matchTopic(MqttMessageType.UP_READ_PROPERTIES_REPLY_DEVICE_MESSAGE.getTopic(), topic);
	}
