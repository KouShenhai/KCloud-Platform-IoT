...
public class DownReadPropertiesDeviceMessageHandler implements MessageHandler {
	...
	public boolean isSubscribe(String topic) {
		return VertxMqttUtils.matchTopic(MqttMessageType.DOWN_READ_PROPERTIES_DEVICE_MESSAGE.getTopic(), topic);
	}
