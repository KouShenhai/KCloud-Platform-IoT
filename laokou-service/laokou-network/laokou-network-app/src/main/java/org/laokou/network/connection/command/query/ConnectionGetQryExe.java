...
/**
 * Network connection detail query executor.
 *
 * @author laokou
 */
@Component
@RequiredArgsConstructor
public class ConnectionGetQryExe {

	private final ConnectionMapper connectionMapper;

	public Result<ConnectionCO> execute(ConnectionGetQry qry) {
		return Result.ok(ConnectionConvertor.toClientObject(connectionMapper.selectById(qry.getId())));
	}
