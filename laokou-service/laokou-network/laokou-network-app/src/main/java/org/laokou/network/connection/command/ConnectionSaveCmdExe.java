...
/**
 * Save network connection command executor.
 *
 * @author laokou
 */
@Component
@RequiredArgsConstructor
public class ConnectionSaveCmdExe {
	...
	@CommandLog
	public void executeVoid(ConnectionSaveCmd cmd) {
		transactionalUtils.executeInTransaction(() -> connectionDomainService
			.createConnection(ConnectionConvertor.toEntity(cmd == null ? null : cmd.getCo())));
	}
