...
public class ModifySourceParamValidator implements SourceParamValidator {

	@Override
	public void validateSource(SourceA sourceA) {
		ParamValidator.validate(sourceA.getValidateName(),
				// 校验数据源ID
				org.laokou.iot.source.service.validator.SourceParamValidator.validateId(sourceA),
				// 校验数据源名称
