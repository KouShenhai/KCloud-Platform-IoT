...
import org.laokou.iot.thing.model.gatewayimpl.database.dataobject.ThingModelDO;
import org.laokou.iot.thing.model.model.ThingModelA;
import org.laokou.iot.thing.model.model.entity.ThingModelE;
import org.laokou.iot.thing.model.model.enums.DataType;
...
final class ThingModelParamValidator {
	...
	static ParamValidator.Validate validateCodeAndName(ThingModelA thingModelA, ThingModelMapper thingModelMapper) {
		...
		if (!RegexUtils.matches("^[a-z][A-Za-z0-9]*$", code)) {
			return ParamValidator.invalidate("物模型编码必须以小写字母开头，大小写字母与数字的组合");
		}
