...
import org.laokou.iot.transportProtocol.dto.TransportProtocolGetQry;
...
public class TransportProtocolGetQryExe {

	private final TransportProtocolMapper transportProtocolMapper;

	public Result<TransportProtocolCO> execute(TransportProtocolGetQry qry) {
		return Result.ok(TransportProtocolConvertor.toClientObject(transportProtocolMapper.selectById(qry.getId())));
	}
