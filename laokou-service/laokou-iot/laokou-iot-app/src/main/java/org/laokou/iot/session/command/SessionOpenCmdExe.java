...
public class SessionOpenCmdExe {
	...
	public void executeVoid(SessionOpenCmd cmd) {
		try {
			...
			SessionA sessionA = SessionDomainFactory.createSessionA().create(SessionConvertor.toEntity(cmd.getId(), cmd.getState()), OperateType.OPEN);
			// 校验参数
