...
import org.laokou.iot.productModel.dto.ProductModelSaveCmd;
...
public class ProductModelSaveCmdExe {

	private final ProductModelDomainService productModelDomainService;

	private final TransactionalUtil transactionalUtil;

	public void executeVoid(ProductModelSaveCmd cmd) {
		// 校验参数
		transactionalUtil
			.executeInTransaction(() -> productModelDomainService.create(ProductModelConvertor.toEntity(cmd.getCo())));
	}
