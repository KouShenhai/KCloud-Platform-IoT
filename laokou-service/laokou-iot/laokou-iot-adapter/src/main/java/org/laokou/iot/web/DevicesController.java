...
public class DevicesController {
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('iot:device:modify')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('iot:device:remove')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('iot:device:import')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('iot:device:export')")
	...
	@PreAuthorize("hasAuthority('read') and hasAuthority('iot:device:page')")
	...
	@PreAuthorize("hasAuthority('read') and hasAuthority('iot:device:detail')")
	@Operation(summary = "查看设备详情", description = "查看设备详情")
	public Result<DeviceCO> getDeviceById(@PathVariable Long id) {
