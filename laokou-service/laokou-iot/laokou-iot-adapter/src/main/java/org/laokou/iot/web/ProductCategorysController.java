...
public class ProductCategorysController {
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('iot:product-category:save')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('iot:product-category:modify')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('iot:product-category:remove')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('iot:product-category:import')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('iot:product-category:export')")
	...
	@PreAuthorize("hasAuthority('read') and hasAuthority('iot:product-category:list-tree')")
