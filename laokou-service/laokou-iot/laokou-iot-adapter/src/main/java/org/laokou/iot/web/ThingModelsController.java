...
public class ThingModelsController {
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('iot:thing-model:save')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('iot:thing-model:modify')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('iot:thing-model:remove')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('iot:thing-model:import')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('iot:thing-model:export')")
	...
	@PreAuthorize("hasAuthority('read') and hasAuthority('iot:thing-model:page')")
	...
	@PreAuthorize("hasAuthority('read') and hasAuthority('iot:thing-model:detail')")
	@Operation(summary = "查看物模型详情", description = "查看物模型详情")
	public Result<ThingModelCO> getThingModelById(@PathVariable Long id) {
