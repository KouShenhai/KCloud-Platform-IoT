...
public class ProductsController {
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('iot:product:save')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('iot:product:modify')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('iot:product:remove')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('iot:product:import')")
	...
	@PreAuthorize("hasAuthority('write') and hasAuthority('iot:product:export')")
	...
	@PreAuthorize("hasAuthority('read') and hasAuthority('iot:product:page')")
