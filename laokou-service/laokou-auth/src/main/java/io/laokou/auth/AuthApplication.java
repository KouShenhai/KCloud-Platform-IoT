 ...
 * @author Kou Shenhai
 */
@SpringBootApplication(scanBasePackages = {"io.laokou.common","io.laokou.auth","io.laokou.redis","io.laokou.log","io.laokou.datasource"})
...
@EnableHystrix
@EnableFeignClients(basePackages = {"io.laokou.datasource","io.laokou.log"})
