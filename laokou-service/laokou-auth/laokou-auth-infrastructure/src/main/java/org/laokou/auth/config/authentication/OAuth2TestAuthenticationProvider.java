...
final class OAuth2TestAuthenticationProvider extends AbstractOAuth2AuthenticationProvider {
	...
	public OAuth2TestAuthenticationProvider(OAuth2AuthorizationService authorizationService, OAuth2TokenGenerator<OAuth2Token> tokenGenerator, OAuth2UsernamePasswordAuthentication oAuth2UsernamePasswordAuthentication, AuthenticationProvider daoAuthenticationProvider) {
