...
public final class DubboOssServiceITriple {
    ...
    private static final StubServiceDescriptor serviceDescriptor = new StubServiceDescriptor(SERVICE_NAME, OssServiceI.class);

    static {
        org.apache.dubbo.rpc.protocol.tri.service.SchemaDescriptorRegistry.addSchemaDescriptor(SERVICE_NAME, OssProto.getDescriptor());
    ...
    org.laokou.oss.api.OssUploadCmd.class, org.laokou.oss.api.OssUploadResult.class, MethodDescriptor.RpcType.UNARY,
    obj -> ((Message) obj).toByteArray(), obj -> ((Message) obj).toByteArray(), org.laokou.oss.api.OssUploadCmd::parseFrom,
    org.laokou.oss.api.OssUploadResult::parseFrom);

    private static final StubMethodDescriptor uploadAsyncMethod = new StubMethodDescriptor("upload",
    org.laokou.oss.api.OssUploadCmd.class, java.util.concurrent.CompletableFuture.class, MethodDescriptor.RpcType.UNARY,
    obj -> ((Message) obj).toByteArray(), obj -> ((Message) obj).toByteArray(), org.laokou.oss.api.OssUploadCmd::parseFrom,
    org.laokou.oss.api.OssUploadResult::parseFrom);
    ...
    public static class OssServiceIStub implements OssServiceI, Destroyable {
        ...
        @Override
        public org.laokou.oss.api.OssUploadResult upload(org.laokou.oss.api.OssUploadCmd request){
            return StubInvocationUtil.unaryCall(invoker, uploadMethod, request);
        }

        public CompletableFuture<org.laokou.oss.api.OssUploadResult> uploadAsync(org.laokou.oss.api.OssUploadCmd request){
            return StubInvocationUtil.unaryCall(invoker, uploadAsyncMethod, request);
        }

        public void upload(org.laokou.oss.api.OssUploadCmd request, StreamObserver<org.laokou.oss.api.OssUploadResult> responseObserver){
    ...
    public static abstract class OssServiceIImplBase implements OssServiceI, ServerService<OssServiceI> {
        ...
        public final Invoker<OssServiceI> getInvoker(URL url) {
            ...
            BiConsumer<org.laokou.oss.api.OssUploadCmd, StreamObserver<org.laokou.oss.api.OssUploadResult>> uploadFunc = this::upload;
            handlers.put(uploadMethod.getMethodName(), new UnaryStubMethodHandler<>(uploadFunc));
            BiConsumer<org.laokou.oss.api.OssUploadCmd, StreamObserver<org.laokou.oss.api.OssUploadResult>> uploadAsyncFunc = syncToAsync(this::upload);
