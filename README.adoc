...
image:https://img.shields.io/static/v1?label=Spring%20Framework&message=7.0.1&color=green[Spring Framework,link=https://spring.io/projects/spring-framework]
image:https://img.shields.io/static/v1?label=Spring%20Security&message=7.0.0&color=green[Spring Security,link=https://spring.io/projects/spring-security]
image:https://img.shields.io/static/v1?label=Spring%20Boot&message=4.0.0&color=green[Spring Boot,link=https://spring.io/projects/spring-boot]
