...
image:https://img.shields.io/static/v1?label=Spring%20Framework&message=7.0.0&color=green[Spring Framework,link=https://spring.io/projects/spring-framework]
