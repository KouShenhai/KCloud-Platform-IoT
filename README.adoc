...
image:https://api.codacy.com/project/badge/Grade/1dbb1e146e784a3f8a96a6cb4e185951[link="https://app.codacy.com/gh/KouShenhai/KCloud-Platform-IoT?utm_source=github.com&utm_medium=referral&utm_content=KouShenhai/KCloud-Platform-IoT&utm_campaign=Badge_Grade"]
...
image:https://img.shields.io/static/v1?label=Spring%20Framework&message=6.1.9&color=green[Spring Framework,link=https://spring.io/projects/spring-framework]
image:https://img.shields.io/static/v1?label=Spring%20Boot&message=3.3.0&color=green[Spring Boot,link=https://spring.io/projects/spring-boot]
...
image:https://img.shields.io/static/v1?label=OAuth%202.1&message=1.3.0&color=blue[OAuth 2.1,link=https://spring.io/projects/spring-authorization-server]
