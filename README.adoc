...
image:https://github.com/KouShenhai/KCloud-Platform-IoT/actions/workflows/go.yml/badge.svg?branch=master[Go CI Build Stauts,link=https://github.com/KouShenhai/KCloud-Platform-IoT/actions/workflows/go.yml]
...
image:https://img.shields.io/static/v1?label=Spring%20Framework&message=7.0.9&color=green[Spring Framework,link=https://spring.io/projects/spring-framework]
image:https://img.shields.io/static/v1?label=Spring%20Security&message=7.1.1&color=green[Spring Security,link=https://spring.io/projects/spring-security]
image:https://img.shields.io/static/v1?label=Spring%20Boot&message=4.1.1&color=green[Spring Boot,link=https://spring.io/projects/spring-boot]
image:https://img.shields.io/static/v1?label=Spring%20Cloud&message=2025.1.3&color=green[Spring Cloud,link=https://spring.io/projects/spring-cloud]
...
|image:doc/image/project/11.png[国际化菜单页面]    |image:doc/image/project/12.png[API文档页面]
|image:doc/image/project/13.png[数据字典页面]    |image:doc/image/project/14.png[数据源页面]
|image:doc/image/project/15.png[会话页面]    |
|===
...
|13  |image:https://avatars.githubusercontent.com/u/105087851?s=60&v=4[freshm4n1的头像,50,50]    |https://github.com/freshm4n1[freshm4n1]
|===
