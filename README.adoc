[![FOSSA Status](https://app.fossa.com/api/projects/git%2Bgithub.com%2FKouShenhai%2FKCloud-Platform-IoT.svg?type=shield)](https://app.fossa.com/projects/git%2Bgithub.com%2FKouShenhai%2FKCloud-Platform-IoT?ref=badge_shield)
...
image:https://img.shields.io/static/v1?label=Spring%20Framework&message=6.2.10&color=green[Spring Framework,link=https://spring.io/projects/spring-framework]
image:https://img.shields.io/static/v1?label=Spring%20Boot&message=3.5.5&color=green[Spring Boot,link=https://spring.io/projects/spring-boot]
...
image:https://img.shields.io/static/v1?label=Spring%20Cloud%20Alibaba&message=2025.0.0.0&color=orange[Spring Cloud Alibaba,link=https://github.com/alibaba/spring-cloud-alibaba]
...
## License
[![FOSSA Status](https://app.fossa.com/api/projects/git%2Bgithub.com%2FKouShenhai%2FKCloud-Platform-IoT.svg?type=large)](https://app.fossa.com/projects/git%2Bgithub.com%2FKouShenhai%2FKCloud-Platform-IoT?ref=badge_large)