...
image:https://img.shields.io/static/v1?label=Spring%20Framework&message=6.2.12&color=green[Spring Framework,link=https://spring.io/projects/spring-framework]
image:https://img.shields.io/static/v1?label=Spring%20Boot&message=3.5.7&color=green[Spring Boot,link=https://spring.io/projects/spring-boot]
...
image:https://img.shields.io/static/v1?label=OAuth%202.1&message=1.5.3&color=blue[OAuth 2.1,link=https://spring.io/projects/spring-authorization-server]
