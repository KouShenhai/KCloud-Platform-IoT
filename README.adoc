...
image:https://img.shields.io/static/v1?label=Spring%20Boot&message=4.0.5&color=green[Spring Boot,link=https://spring.io/projects/spring-boot]
...
image:https://img.shields.io/badge/GraalVM-25.0.0-blue.svg[GraalVM,link=https://www.graalvm.org/downloads]
image:https://img.shields.io/badge/Maven-3.9.11-blue[Maven,link=https://maven.apache.org/]
...
|image:doc/image/project/11.png[国际化菜单]    |image:doc/image/project/12.png[API文档]
|===
...
https://docs.qq.com/sheet/DUGhCdGVZWmVxT0VJ[开发计划（需要登录）]
...
- 采用Apache2.0和MIT双协议，任选其一，请保留作者、Copyright信息【免费用于毕设、二开、商用、二次开源】
- 采用Apache2.0和MIT双协议，任选其一，请保留作者、Copyright信息【免费用于毕设、二开、商用、二次开源】
- 采用Apache2.0和MIT双协议，任选其一，请保留作者、Copyright信息【免费用于毕设、二开、商用、二次开源】
...
- KCloud-Platform-IoT 开源软件遵循 https://opensource.org/licenses/MIT[MIT 协议] 请务必保留作者、Copyright信息
...
image::doc/image/gitcode.jpg[2025年GitCode百大开源项目]

https://v.douyin.com/fhQd0Bp8f40[抖音视频-GitCode百大开源项目获奖感谢]

https://www.bilibili.com/video/BV1zeCCBcEn5[哔哩哔哩视频-GitCode百大开源项目获奖感谢]
...
|12  |image:https://avatars.githubusercontent.com/u/121850259?s=60&v=4[sd-xiaoZheng的头像,50,50]    |https://github.com/sd-xiaoZheng[sd-xiaoZheng]
|===
