...
Specify edge gateway local user management, including API CRUD operations, password management, local YAML persistence, default admin initialization, and frontend access control.
