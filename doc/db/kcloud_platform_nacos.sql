...
knife4j:
  enable: true
  setting:
    language: zh_cn', '77f6b523eaa95adb3aea41eeed4db40e', '2024-05-25 18:13:33.393', '2024-11-07 00:18:34.376', 'nacos', '0:0:0:0:0:0:0:1', '', '0dac1a68-2f01-40df-bd26-bf0cb199057a', '', '', '', 'yaml', '', '');
...
knife4j:
  enable: false
  setting:
    language: zh_cn', 'bbfdbc5a2f25c44be2eefba07120003d', '2024-05-25 18:13:10.622', '2024-11-07 00:18:19.073', 'nacos', '0:0:0:0:0:0:0:1', '', '8140e92b-fb43-48f5-b63b-7506185206a5', '', '', '', 'yaml', '', '');
...
mybatis-plus:
  ...
  configuration:
    log-impl: org.apache.ibatis.logging.nologging.NoLoggingImpl', '236d532282616dc82f6e5a30ec8f07a2', '2024-05-25 18:13:10.69', '2024-11-11 20:57:16.11', 'nacos', '0:0:0:0:0:0:0:1', 'laokou-admin', '8140e92b-fb43-48f5-b63b-7506185206a5', '', '', '', 'yaml', '', '');
...
mybatis-plus:
  ...
  mapper-locations: classpath*:/mapper/**/*.xml
  configuration:
    log-impl: org.apache.ibatis.logging.nologging.NoLoggingImpl', '3c367904f40e28b9cdfe9569bfe30ade', '2023-09-28 11:51:44', '2024-11-11 20:58:36.162', 'nacos', '0:0:0:0:0:0:0:1', 'laokou-auth', 'a61abd4c-ef96-42a5-99a1-616adee531f3', '', '', '', 'yaml', '', '');
...
mybatis-plus:
  ...
  mapper-locations: classpath*:/mapper/**/*.xml
  configuration:
    log-impl: org.apache.ibatis.logging.nologging.NoLoggingImpl', 'cd7ef0d675ac2cc780f14dc3b955ff8f', '2023-09-28 11:37:33', '2024-11-11 20:56:18.045', 'nacos', '0:0:0:0:0:0:0:1', 'laokou-admin', 'a61abd4c-ef96-42a5-99a1-616adee531f3', '', '', '', 'yaml', '', '');
...
mybatis-plus:
  ...
  mapper-locations: classpath*:/mapper/**/*.xml
  configuration:
    log-impl: org.apache.ibatis.logging.nologging.NoLoggingImpl', '3adf7d4d034f8d7663b223398e0fe3a3', '2024-05-25 18:13:10.697', '2024-11-11 20:59:22.652', 'nacos', '0:0:0:0:0:0:0:1', 'laokou-auth', '8140e92b-fb43-48f5-b63b-7506185206a5', '', '', '', 'yaml', '', '');
...
mybatis-plus:
  ...
  mapper-locations: classpath*:/mapper/**/*.xml
  configuration:
    log-impl: org.apache.ibatis.logging.nologging.NoLoggingImpl', '5d3fe9479809e191182c37e7df8b096a', '2024-05-25 18:13:33.452', '2024-11-11 20:59:01.684', 'nacos', '0:0:0:0:0:0:0:1', 'laokou-auth', '0dac1a68-2f01-40df-bd26-bf0cb199057a', '', '', '', 'yaml', '', '');
...
knife4j:
  enable: true
  setting:
    language: zh_cn', '021876272490bbce5572dd7e3ac1f6b7', '2023-01-13 12:16:46', '2024-11-07 00:18:48.784', 'nacos', '0:0:0:0:0:0:0:1', '', 'a61abd4c-ef96-42a5-99a1-616adee531f3', '', '', '', 'yaml', '', '');
...
INSERT INTO "public"."config_info" VALUES (4, 'application-iot.yaml', 'LAOKOU_GROUP', '# jasypt
jasypt:
  encryptor:
    password: 5201314wumeihua
...
mybatis-plus:
  ...
  mapper-locations: classpath*:/mapper/**/*.xml
  configuration:
    log-impl: org.apache.ibatis.logging.nologging.NoLoggingImpl', 'fb385d7f5feef2bb7f9ae967b3e73605', '2024-11-06 22:52:26.903', '2024-11-06 22:57:58.491', 'nacos', '0:0:0:0:0:0:0:1', 'laokou-iot', '8140e92b-fb43-48f5-b63b-7506185206a5', '', '', '', 'yaml', '', '');
INSERT INTO "public"."config_info" VALUES (1, 'application-iot.yaml', 'LAOKOU_GROUP', '# jasypt
jasypt:
  encryptor:
    password: 5201314wumeihua
...
mybatis-plus:
  ...
  mapper-locations: classpath*:/mapper/**/*.xml
  configuration:
    log-impl: org.apache.ibatis.logging.nologging.NoLoggingImpl', '97bc005f228047c753d09ec3b5c66fc1', '2024-11-06 22:51:23.767', '2024-11-06 22:57:28.842', 'nacos', '0:0:0:0:0:0:0:1', 'laokou-iot', 'a61abd4c-ef96-42a5-99a1-616adee531f3', '', '', '', 'yaml', '', '');
...
mybatis-plus:
  ...
  mapper-locations: classpath*:/mapper/**/*.xml
  configuration:
    log-impl: org.apache.ibatis.logging.nologging.NoLoggingImpl', '9ead1ae72f4434d0b5c19cd5019ca69d', '2024-05-25 18:13:33.447', '2024-11-11 20:56:44.895', 'nacos', '0:0:0:0:0:0:0:1', 'laokou-admin', '0dac1a68-2f01-40df-bd26-bf0cb199057a', '', '', '', 'yaml', '', '');
INSERT INTO "public"."config_info" VALUES (3, 'application-iot.yaml', 'LAOKOU_GROUP', '# jasypt
jasypt:
  encryptor:
    password: 5201314wumeihua
...
mybatis-plus:
  ...
  mapper-locations: classpath*:/mapper/**/*.xml
  configuration:
    log-impl: org.apache.ibatis.logging.nologging.NoLoggingImpl', '7b73b31247a734027ff59b21c40a42e8', '2024-11-06 22:52:13.959', '2024-11-06 22:57:45.05', 'nacos', '0:0:0:0:0:0:0:1', 'laokou-iot', '0dac1a68-2f01-40df-bd26-bf0cb199057a', '', '', '', 'yaml', '', '');
  ...
  gateway:
    ...
    routes:
      ...
      - name: 管理服务
        ...
        context-path: /admin
        order: 2', 'e2aca97c01b1a2fd97b8c57f02b1f15b', '2023-01-22 13:16:13', '2024-11-11 20:52:58.942', 'nacos', '0:0:0:0:0:0:0:1', 'laokou-gateway', 'a61abd4c-ef96-42a5-99a1-616adee531f3', 'gateway配置', '', '', 'yaml', '', '');
  ...
  gateway:
    ...
    routes:
      ...
      - name: 管理服务
        ...
        service-name: laokou-admin
        context-path: /admin
        order: 2', 'f5009a7f5840dea4142b5d0c9b7b7de9', '2024-05-25 18:13:33.458', '2024-11-11 20:53:26.465', 'nacos', '0:0:0:0:0:0:0:1', 'laokou-gateway', '0dac1a68-2f01-40df-bd26-bf0cb199057a', 'gateway配置', '', '', 'yaml', '', '');
  ...
  gateway:
    ...
    routes:
      ...
      - name: 管理服务
        ...
        service-name: laokou-admin
        context-path: /admin
        order: 2', '47c29a8140499f600d3b23774576f72b', '2024-05-25 18:13:10.704', '2024-11-11 20:53:42.459', 'nacos', '0:0:0:0:0:0:0:1', 'laokou-gateway', '8140e92b-fb43-48f5-b63b-7506185206a5', 'gateway配置', '', '', 'yaml', '', '');
INSERT INTO "public"."config_info" VALUES (9, 'auth-flow.json', 'LAOKOU_GROUP', '[
  {
...
INSERT INTO "public"."config_info" VALUES (7, 'auth-flow.json', 'LAOKOU_GROUP', '[
  {
    "resource": "/v3/captchas/{uuid}",
    "limitApp": "default",
    "count": 100000,
...
INSERT INTO "public"."config_info" VALUES (8, 'auth-flow.json', 'LAOKOU_GROUP', '[
  {
    "resource": "/v3/captchas/{uuid}",
    "limitApp": "default",
    "count": 100000,
...
INSERT INTO "public"."config_tags_relation" VALUES (26, 'gateway', '', 'router.json', 'LAOKOU_GROUP', 'a61abd4c-ef96-42a5-99a1-616adee531f3', 8);
INSERT INTO "public"."config_tags_relation" VALUES (1, 'iot', '', 'application-iot.yaml', 'LAOKOU_GROUP', 'a61abd4c-ef96-42a5-99a1-616adee531f3', 15);
INSERT INTO "public"."config_tags_relation" VALUES (3, 'iot', '', 'application-iot.yaml', 'LAOKOU_GROUP', '0dac1a68-2f01-40df-bd26-bf0cb199057a', 16);
INSERT INTO "public"."config_tags_relation" VALUES (4, 'iot', '', 'application-iot.yaml', 'LAOKOU_GROUP', '8140e92b-fb43-48f5-b63b-7506185206a5', 17);
...
INSERT INTO "public"."config_tags_relation" VALUES (1567, 'gateway', '', 'gateway-flow.json', 'LAOKOU_GROUP', 'a61abd4c-ef96-42a5-99a1-616adee531f3', 1);
INSERT INTO "public"."config_tags_relation" VALUES (1273, 'gateway', '', 'application-gateway.yaml', 'LAOKOU_GROUP', 'a61abd4c-ef96-42a5-99a1-616adee531f3', 4);
INSERT INTO "public"."config_tags_relation" VALUES (2022, 'admin', '', 'application-admin.yaml', 'LAOKOU_GROUP', 'a61abd4c-ef96-42a5-99a1-616adee531f3', 7);
INSERT INTO "public"."config_tags_relation" VALUES (68, 'admin', '', 'application-admin.yaml', 'LAOKOU_GROUP', '0dac1a68-2f01-40df-bd26-bf0cb199057a', 9);
INSERT INTO "public"."config_tags_relation" VALUES (46, 'admin', '', 'application-admin.yaml', 'LAOKOU_GROUP', '8140e92b-fb43-48f5-b63b-7506185206a5', 10);
INSERT INTO "public"."config_tags_relation" VALUES (2025, 'auth', '', 'application-auth.yaml', 'LAOKOU_GROUP', 'a61abd4c-ef96-42a5-99a1-616adee531f3', 11);
INSERT INTO "public"."config_tags_relation" VALUES (69, 'auth', '', 'application-auth.yaml', 'LAOKOU_GROUP', '0dac1a68-2f01-40df-bd26-bf0cb199057a', 13);
INSERT INTO "public"."config_tags_relation" VALUES (47, 'auth', '', 'application-auth.yaml', 'LAOKOU_GROUP', '8140e92b-fb43-48f5-b63b-7506185206a5', 14);
