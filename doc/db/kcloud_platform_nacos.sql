...
-- ----------------------------
INSERT INTO "public"."his_config_info" VALUES (0, 28, '1', 'DEFAULT_GROUP', '', '1', 'c4ca4238a0b923820dcc509a6f75849b', '2024-12-15 20:18:25.239331', '2024-12-15 20:18:25.242', 'nacos', '127.0.0.1', 'I         ', '', '');
INSERT INTO "public"."his_config_info" VALUES (5, 29, '1', 'DEFAULT_GROUP', '', '1', 'c4ca4238a0b923820dcc509a6f75849b', '2024-12-15 20:18:30.923854', '2024-12-15 20:18:30.921', 'nacos', '127.0.0.1', 'D         ', '', '');
INSERT INTO "public"."his_config_info" VALUES (0, 30, '1', 'SEATA_GROUP', '', '1', 'c4ca4238a0b923820dcc509a6f75849b', '2024-12-15 20:26:23.2847', '2024-12-15 20:26:23.285', 'nacos', '127.0.0.1', 'I         ', '', '');
INSERT INTO "public"."his_config_info" VALUES (109, 31, '1', 'SEATA_GROUP', '', '1', 'c4ca4238a0b923820dcc509a6f75849b', '2024-12-15 20:27:53.897997', '2024-12-15 20:27:53.895', 'nacos', '127.0.0.1', 'D         ', '', '');
INSERT INTO "public"."his_config_info" VALUES (0, 32, 'seataServer.properties', 'SEATA_GROUP', 'laokou-sample-seata-server', '#For details about configuration items, see https://seata.io/zh-cn/docs/user/configurations.html
...
metrics.exporterPrometheusPort=9898', 'a7c7188f1828b0521c7ce82a105bc070', '2024-12-15 20:30:03.55177', '2024-12-15 20:30:03.556', 'nacos', '127.0.0.1', 'I         ', '', '');
...
INSERT INTO "public"."config_tags_relation" VALUES (17, 'common', '', 'application-common.yaml', 'LAOKOU_GROUP', 'a61abd4c-ef96-42a5-99a1-616adee531f3', 32);
INSERT INTO "public"."config_tags_relation" VALUES (2025, 'auth', '', 'application-auth.yaml', 'LAOKOU_GROUP', 'a61abd4c-ef96-42a5-99a1-616adee531f3', 33);
INSERT INTO "public"."config_tags_relation" VALUES (2022, 'admin', '', 'application-admin.yaml', 'LAOKOU_GROUP', 'a61abd4c-ef96-42a5-99a1-616adee531f3', 34);
INSERT INTO "public"."config_tags_relation" VALUES (68, 'admin', '', 'application-admin.yaml', 'LAOKOU_GROUP', '0dac1a68-2f01-40df-bd26-bf0cb199057a', 35);
INSERT INTO "public"."config_tags_relation" VALUES (69, 'auth', '', 'application-auth.yaml', 'LAOKOU_GROUP', '0dac1a68-2f01-40df-bd26-bf0cb199057a', 36);
INSERT INTO "public"."config_tags_relation" VALUES (47, 'auth', '', 'application-auth.yaml', 'LAOKOU_GROUP', '8140e92b-fb43-48f5-b63b-7506185206a5', 37);
INSERT INTO "public"."config_tags_relation" VALUES (46, 'admin', '', 'application-admin.yaml', 'LAOKOU_GROUP', '8140e92b-fb43-48f5-b63b-7506185206a5', 38);
INSERT INTO "public"."config_tags_relation" VALUES (1, 'iot', '', 'application-iot.yaml', 'LAOKOU_GROUP', 'a61abd4c-ef96-42a5-99a1-616adee531f3', 39);
INSERT INTO "public"."config_tags_relation" VALUES (3, 'iot', '', 'application-iot.yaml', 'LAOKOU_GROUP', '0dac1a68-2f01-40df-bd26-bf0cb199057a', 40);
INSERT INTO "public"."config_tags_relation" VALUES (4, 'iot', '', 'application-iot.yaml', 'LAOKOU_GROUP', '8140e92b-fb43-48f5-b63b-7506185206a5', 41);
INSERT INTO "public"."config_tags_relation" VALUES (209, 'seata-server', '', 'seataServer.properties', 'SEATA_GROUP', '', 42);
...
spring:
  ...
  mail:
    ...
    password: ENC(f59eMZTlDign/pXa05K6NXvbNAopK8YSAoskm9WJC8UVbWxbTfCOHn6jfFSnZrH1ww+iFeTfmdxvlyA8I+IUIg==)
...
INSERT INTO "public"."config_info" VALUES (86, 'application-mail.yaml', 'LAOKOU_GROUP', '# jasypt
jasypt:
  encryptor:
    password: 5201314wumeihua
spring:
...
INSERT INTO "public"."config_info" VALUES (89, 'application-auth.yaml', 'LAOKOU_GROUP', '# jasypt
jasypt:
  encryptor:
    password: 5201314wumeihua
...
INSERT INTO "public"."config_info" VALUES (100, 'auth-flow.json', 'LAOKOU_GROUP', '[
  {
    "resource": "/v3/captchas/{uuid}",
    "limitApp": "default",
    "count": 100000,
...
INSERT INTO "public"."config_info" VALUES (83, 'application-common-rocketmq.yaml', 'LAOKOU_GROUP', 'rocketmq:
  producer:
    group: laokou_producer_group
  name-server: rocketmq-namesrv:9876
  consumer:
...
INSERT INTO "public"."config_info" VALUES (84, 'application-gateway.yaml', 'LAOKOU_GROUP', 'server:
  # 开启请求压缩
  compression:
    enabled: true
  ssl:
...
INSERT INTO "public"."config_info" VALUES (85, 'application-sms.yaml', 'LAOKOU_GROUP', '# jasypt
jasypt:
  encryptor:
    password: 5201314wumeihua
sms:
...
INSERT INTO "public"."config_info" VALUES (87, 'gateway-flow.json', 'LAOKOU_GROUP', '[
  {
    "resource": "laokou-auth",
    "grade": 1,
    "count": 100000,
...
INSERT INTO "public"."config_info" VALUES (88, 'application-admin.yaml', 'LAOKOU_GROUP', '# jasypt
jasypt:
  encryptor:
    password: 5201314wumeihua
...
INSERT INTO "public"."config_info" VALUES (91, 'application-common-kafka.yaml', 'LAOKOU_GROUP', 'spring:
  kafka:
    bootstrap-servers: kafka:9092
    consumer:
      # 禁用自动提交（按周期）已消费offset
...
INSERT INTO "public"."config_info" VALUES (209, 'seataServer.properties', 'SEATA_GROUP', '#For details about configuration items, see https://seata.io/zh-cn/docs/user/configurations.html
#Transport configuration, for client and server
transport.type=TCP
transport.server=NIO
transport.heartbeat=true
...
-- ----------------------------
SELECT setval('"public"."his_config_info_nid_seq"', 32, true);
...
-- ----------------------------
SELECT setval('"public"."config_tags_relation_nid_seq"', 42, true);
...
-- ----------------------------
SELECT setval('"public"."config_info_id_seq"', 209, true);
