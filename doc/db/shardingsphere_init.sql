...
-- ------------------------------------用户------------------------------------
UPDATE `kcloud_platform_alibaba_user_0`.`boot_sys_user_1` SET `username` = '1ftkBJEIvmOFuxJygs2jnQ==', `password` = '$2a$10$vFo4D9UwvFd6yIG3F3cZEe/RCScCooJqismrRV/FWh6F.qmDCPgxu', `super_admin` = 1, `creator` = 1341620898007281665, `editor` = 1341620898007281665, `create_date` = '2021-11-29 20:13:11', `update_date` = '2022-10-26 19:24:55', `del_flag` = 0, `mail` = 'LkZpbZYqPmJRj54OG9P8xdgn8lmGt/9oxQT94xbsZyE=', `status` = 0, `avatar` = 'http://127.0.0.1/upload/node3/7904fff1c08a4883b40f1ee0336017dc.webp', `mobile` = 'i7KGWPr+sZqGBXO4JViAGg==', `dept_id` = 0, `version` = 18, `tenant_id` = 0 WHERE `id` = 1341620898007281665;
UPDATE `kcloud_platform_alibaba_user_0`.`boot_sys_user_1` SET `username` = 'xa1Nz1ENwGc9qWoUseZn6A==', `password` = '$2a$10$jaQ.syONdH/N/UWTX6lwx.Hme2CElmCGhu0OiairxBkneSEvBD8Fe', `super_admin` = 0, `creator` = 1341620898007281665, `editor` = 1341620898007281665, `create_date` = '2023-03-09 13:52:04', `update_date` = '2023-03-09 13:52:04', `del_flag` = 0, `mail` = NULL, `status` = 0, `avatar` = 'http://127.0.0.1/upload/node2/b4e5bb3944a046a6bb54f8bfd2c830c1.webp', `mobile` = NULL, `dept_id` = 1535881356595175426, `version` = 16, `tenant_id` = 0 WHERE `id` = 1341623527018004481;