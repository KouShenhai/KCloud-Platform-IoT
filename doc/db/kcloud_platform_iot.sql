...
DROP TABLE IF EXISTS "public"."network_connection";
...
COMMENT ON COLUMN "public"."network_connection"."creator" IS '创建人';
COMMENT ON COLUMN "public"."network_connection"."editor" IS '编辑人';
COMMENT ON COLUMN "public"."network_connection"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."network_connection"."update_time" IS '修改时间';
COMMENT ON COLUMN "public"."network_connection"."del_flag" IS '删除标识 0未删除 1已删除';
COMMENT ON COLUMN "public"."network_connection"."version" IS '版本号';
COMMENT ON COLUMN "public"."network_connection"."tenant_id" IS '租户ID';
COMMENT ON COLUMN "public"."network_connection"."dept_id" IS '部门ID';
COMMENT ON COLUMN "public"."network_connection"."name" IS '连接名称';
COMMENT ON COLUMN "public"."network_connection"."type" IS '连接类型 1 MQTT Server 2 HTTP Server 3 MQTT Client 4 Kafka 5 RabbitMQ';
COMMENT ON COLUMN "public"."network_connection"."host" IS '主机地址';
COMMENT ON COLUMN "public"."network_connection"."port" IS '端口';
COMMENT ON COLUMN "public"."network_connection"."enabled" IS '启用状态 0启用 1停用';
COMMENT ON COLUMN "public"."network_connection"."config" IS '连接配置JSON';
COMMENT ON COLUMN "public"."network_connection"."remark" IS '备注';
COMMENT ON TABLE "public"."network_connection" IS '网络连接';
ALTER TABLE "public"."network_connection" ADD CONSTRAINT "network_connection_pkey" PRIMARY KEY ("id");

CREATE UNIQUE INDEX IF NOT EXISTS "network_connection_name_tenantId_idx"
ON "public"."network_connection" USING btree ("name", "tenant_id")
WHERE del_flag = 0;
COMMENT ON INDEX "public"."network_connection_name_tenantId_idx" IS '连接名称_租户ID_未删除唯一索引';
