...
VALUES (1, 1537114827246292994, 1707428076142559234, '2023-09-12 23:49:06.000000', '2024-01-04 16:41:26.000000', 0, 5,
		...
		'tenant_000001', 'com.mysql.cj.jdbc.Driver',
		'jdbc:mysql://mysql.laokou.org:3306/kcloud_platform_alibaba_tenant?characterEncoding=utf8&connectTimeout=1000&socketTimeout=3000&autoReconnect=true&useUnicode=true&useSSL=false&serverTimezone=Asia/Shanghai&allowPublicKeyRetrieval=true',
		'root', 'laokou123');
...
comment on column public.boot_sys_sql_log.app_name is '应用名称';
...
create index if not exists boot_sys_sql_log_app_name_idx
	on public.boot_sys_sql_log (app_name);
