...
ALTER TABLE "public"."boot_generator_column" ADD CONSTRAINT "boot_generator_column_pkey" PRIMARY KEY ("id");
...
ALTER TABLE "public"."boot_generator_info" ADD CONSTRAINT "boot_generator_info_pkey" PRIMARY KEY ("id");
...
ALTER TABLE "public"."boot_generator_template" ADD CONSTRAINT "boot_generator_template_pkey" PRIMARY KEY ("id");
