...
UPDATE `boot_sys_user` SET `username` = '1ftkBJEIvmOFuxJygs2jnQ==', `password` = '$2a$10$vFo4D9UwvFd6yIG3F3cZEe/RCScCooJqismrRV/FWh6F.qmDCPgxu', `super_admin` = 1, `creator` = 1341620898007281665, `editor` = 1341620898007281665, `create_date` = '2021-11-29 20:13:11', `update_date` = '2022-10-26 19:24:55', `del_flag` = 0, `mail` = 'LkZpbZYqPmJRj54OG9P8xdgn8lmGt/9oxQT94xbsZyE=', `status` = 0, `avatar` = 'http://175.178.69.253:81/upload/node3/7904fff1c08a4883b40f1ee0336017dc.webp', `mobile` = 'fX158CgrUru6HxUVFeaDdQ==', `dept_id` = 0, `version` = 8, `tenant_id` = 0 WHERE `id` = 1341620898007281665;
UPDATE `boot_sys_user` SET `username` = 'xa1Nz1ENwGc9qWoUseZn6A==', `password` = '$2a$10$jaQ.syONdH/N/UWTX6lwx.Hme2CElmCGhu0OiairxBkneSEvBD8Fe', `super_admin` = 0, `creator` = 1341620898007281665, `editor` = 1341620898007281665, `create_date` = '2023-03-09 13:52:04', `update_date` = '2023-03-09 13:52:04', `del_flag` = 0, `mail` = NULL, `status` = 0, `avatar` = 'http://175.178.69.253:81/upload/node2/b4e5bb3944a046a6bb54f8bfd2c830c1.webp', `mobile` = NULL, `dept_id` = 1535881356595175426, `version` = 0, `tenant_id` = 0 WHERE `id` = 1341623527018004481;
UPDATE `boot_sys_user` SET `username` = 'UZdko/elN7be8o8HlsNYDw==', `password` = '$2a$10$ysAmruc249SiAUpIqQzrpeM8wcdpgIJ6nEdtsXQnDrBgvLZkt7tJ6', `super_admin` = 0, `creator` = 1341620898007281665, `editor` = 1341620898007281665, `create_date` = '2021-07-31 11:29:35', `update_date` = '2022-11-04 00:13:05', `del_flag` = 0, `mail` = '', `status` = 0, `avatar` = 'https://img2.baidu.com/it/u=2432885784,4104422384&fm=253&fmt=auto&app=138&f=JPEG?w=400&h=400', `mobile` = '', `dept_id` = 1535881356595175426, `version` = 6, `tenant_id` = 0 WHERE `id` = 1421312053736804354;
UPDATE `boot_sys_user` SET `username` = 'WPvtQBxvQwzVj5SJsKCifQ==', `password` = '$2a$10$Wac.3sTE4A4pi/Zy6B/HWOstwLFjOH9g8Qrf4gHiBLa/avKAVcwpG', `super_admin` = 0, `creator` = 1341620898007281665, `editor` = 1341620898007281665, `create_date` = '2022-06-16 00:33:39', `update_date` = '2022-10-24 18:40:20', `del_flag` = 0, `mail` = NULL, `status` = 0, `avatar` = 'https://img2.baidu.com/it/u=2432885784,4104422384&fm=253&fmt=auto&app=138&f=JPEG?w=400&h=400', `mobile` = NULL, `dept_id` = 1535858679453085698, `version` = 17, `tenant_id` = 0 WHERE `id` = 1537111101311844353;
UPDATE `boot_sys_user` SET `username` = 'JSB4EWKd5aI/aISsDw0ODA==', `password` = '$2a$10$b.40TGb7W19z5Jryo3FBuOEDaX2c0OAqZHnRnCkXCPI67ru5G7Nha', `super_admin` = 0, `creator` = 1341620898007281665, `editor` = 1341620898007281665, `create_date` = '2022-06-16 00:48:28', `update_date` = '2022-10-26 19:40:13', `del_flag` = 0, `mail` = NULL, `status` = 0, `avatar` = 'https://img2.baidu.com/it/u=2432885784,4104422384&fm=253&fmt=auto&app=138&f=JPEG?w=400&h=400', `mobile` = NULL, `dept_id` = 1535881356595175426, `version` = 23, `tenant_id` = 0 WHERE `id` = 1537114827246292994;
UPDATE `boot_sys_user` SET `username` = '5/Pqo/yVzE72YyPDE5RKAw==', `password` = '$2a$10$ToBq5JB191IUkAfnqfeV5OFLOFDvhr9wWaRm1LhTn5sbL8uyJ0Gre', `super_admin` = 1, `creator` = 1341620898007281665, `editor` = 1341620898007281665, `create_date` = '2023-02-09 22:59:04', `update_date` = '2023-02-09 22:59:04', `del_flag` = 0, `mail` = NULL, `status` = 0, `avatar` = 'https://img2.baidu.com/it/u=2432885784,4104422384&fm=253&fmt=auto&app=138&f=JPEG?w=400&h=400', `mobile` = NULL, `dept_id` = 0, `version` = 0, `tenant_id` = 1 WHERE `id` = 1537114827246292998;
