 ...
 */
@AutoConfiguration
@ComponentScan("org.laokou.common.hbase")
public class HbaseAutoConfig {
	...
	/**
	 * @Scope标明模式，默认单例模式，prototype多例模式 若是在其他类中直接@Autowired引入的，多例就无效，因为那个类在初始化的时候，已经创建了这个bean，之后调用，不会重新创建
