...
public class MqttClientAutoReconnectImpl implements MqttClientAutoReconnect, MqttClientConnectedListener {
	...
	static final long DEFAULT_START_DELAY_NANOS = TimeUnit.SECONDS
		.toNanos(MqttClientAutoReconnect.DEFAULT_START_DELAY_S);
	static final long DEFAULT_MAX_DELAY_NANOS = TimeUnit.SECONDS.toNanos(MqttClientAutoReconnect.DEFAULT_MAX_DELAY_S);

	public static final @NotNull MqttClientAutoReconnectImpl DEFAULT = new MqttClientAutoReconnectImpl(
			DEFAULT_START_DELAY_NANOS, DEFAULT_MAX_DELAY_NANOS);
