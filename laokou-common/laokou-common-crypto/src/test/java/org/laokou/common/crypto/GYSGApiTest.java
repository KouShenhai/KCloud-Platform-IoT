...
public class GYSGApiTest {
    public static void main(String[] args) {
        ...
        String str = """
                ...
                站姿：{}
                """;
        log.info(str, data.currentHeight, data.maxHeight, data.minHeight, data.scale, data.height, adorn.cloak,adorn.prop,adorn.neck,adorn.mask,adorn.horn,adorn.hair,adorn.pants,action.voice,action.attitude);
    }
