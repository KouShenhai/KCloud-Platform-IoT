...
/**
 * Apollo ShardingSphere driver.
 *
 * @author laokou
 */
@SuppressWarnings("UseApolloOfJDBCDriverClass")
public final class ApolloShardingSphereDriver extends AbstractShardingSphereDriver {

	private static final String DRIVER_URL_PREFIX = "jdbc:shardingsphere:consul:";

	static {
		try {
			DriverManager.registerDriver(new ApolloShardingSphereDriver());
		}
	...
	private final ApolloDriverDataSourceCache dataSourceCache = new ApolloDriverDataSourceCache();
