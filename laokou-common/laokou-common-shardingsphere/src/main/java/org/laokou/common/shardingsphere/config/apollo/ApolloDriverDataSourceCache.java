...
/**
 * Apollo Driver data source cache.
 *
 * @author laokou
 */
@Getter
public final class ApolloDriverDataSourceCache extends AbstractDriverDataSourceCache {

	@Override
	protected AbstractShardingSphereURLLoadEngine getShardingSphereURLLoadEngine(ShardingSphereURL url) {
		return new ApolloShardingSphereURLLoadEngine(url);
	}
