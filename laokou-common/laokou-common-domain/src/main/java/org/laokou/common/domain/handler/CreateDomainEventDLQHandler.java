...
import static org.laokou.common.domain.constant.MqConstant.LAOKOU_CREATE_EVENT_CONSUMER_GROUP_DLQ;
...
public class CreateDomainEventDLQHandler extends AbstractDLQHandler {
	...
	public CreateDomainEventDLQHandler(DomainEventPublisher domainEventPublisher) {
