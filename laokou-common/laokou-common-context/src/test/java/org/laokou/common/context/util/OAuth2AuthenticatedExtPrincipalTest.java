...
class OAuth2AuthenticatedExtPrincipalTest {
	...
	void test_builder_allProperties_createsUserExtDetails() {
		...
		Assertions.assertThat(principal.getUsername()).isEqualTo("testuser");
		Assertions.assertThat(principal.getAvatar()).isEqualTo("https://example.com/avatar.png");
		Assertions.assertThat(principal.getSuperAdmin()).isTrue();
		Assertions.assertThat(principal.getStatus()).isZero();
		Assertions.assertThat(principal.getMail()).isEqualTo("test@example.com");
		Assertions.assertThat(principal.getMobile()).isEqualTo("13800138000");
		Assertions.assertThat(principal.getTenantId()).isEqualTo(100L);
		Assertions.assertThat(principal.getDeptId()).isEqualTo(10L);
		Assertions.assertThat(principal.getPermissions())
			.hasSize(2)
	...
	void test_toBuilder_modifyProperties_createsNewInstance() {
		// When
		OAuth2AuthenticatedExtPrincipal modified = principal.toBuilder().id(999L).username("newuser").build();
	...
	void test_classType_always_implementsUserDetails() {
		// Then
		Assertions.assertThat(principal).isInstanceOf(OAuth2AuthenticatedPrincipal.class);
	}
	...
	void test_equals_sameKeyFields_returnsTrue() {
		// Given
		OAuth2AuthenticatedExtPrincipal sameUser = OAuth2AuthenticatedExtPrincipal.builder()
			.id(1L)
			.username("testuser")
		...
		OAuth2AuthenticatedExtPrincipal differentUser = OAuth2AuthenticatedExtPrincipal.builder()
			.id(2L)
			.username("otheruser")
			.tenantId(100L)
			.deptId(10L)
		...
		// Then
		Assertions.assertThat(principal).isEqualTo(sameUser);
		Assertions.assertThat(principal.hashCode()).isEqualTo(sameUser.hashCode());
		Assertions.assertThat(principal).isNotEqualTo(differentUser);
	}
	...
	void test_builder_nullValues_createsUserExtDetailsWithNulls() {
		// Given
		OAuth2AuthenticatedExtPrincipal nullUser = OAuth2AuthenticatedExtPrincipal.builder()
			.id(null)
			.username(null)
			.avatar(null)
			.superAdmin(null)
	...
	void test_decryptUsername_encryptedUsername_returnsDecrypted() throws Exception {
		...
		OAuth2AuthenticatedExtPrincipal userWithEncryptedUsername = OAuth2AuthenticatedExtPrincipal.builder()
			.id(1L)
			.username(encryptedUsername)
			.build();

		// When
		OAuth2AuthenticatedExtPrincipal decrypted = userWithEncryptedUsername.decryptUsername();
	...
	void test_decryptMail_encryptedMail_returnsDecrypted() throws Exception {
		...
		OAuth2AuthenticatedExtPrincipal userWithEncryptedMail = org.laokou.common.context.util.OAuth2AuthenticatedExtPrincipal
			.builder()
			.id(1L)
			.mail(encryptedMail)
			.build();
		...
		// When
		OAuth2AuthenticatedExtPrincipal decrypted = userWithEncryptedMail.decryptMail();
	...
	void test_decryptMobile_encryptedMobile_returnsDecrypted() throws Exception {
		...
		OAuth2AuthenticatedExtPrincipal userWithEncryptedMobile = OAuth2AuthenticatedExtPrincipal.builder()
			.id(1L)
			.mobile(encryptedMobile)
			.build();

		// When
		OAuth2AuthenticatedExtPrincipal decrypted = userWithEncryptedMobile.decryptMobile();
	...
	void test_decryptUsername_nullUsername_returnsSameInstance() {
		// Given
		OAuth2AuthenticatedExtPrincipal userWithNullUsername = OAuth2AuthenticatedExtPrincipal.builder()
			.id(1L)
			.username(null)
			.build();

		// When
		OAuth2AuthenticatedExtPrincipal result = userWithNullUsername.decryptUsername();
	...
	void test_decryptUsername_emptyUsername_returnsSameInstance() {
		// Given
		OAuth2AuthenticatedExtPrincipal userWithEmptyUsername = OAuth2AuthenticatedExtPrincipal.builder()
			.id(1L)
			.username("")
			.build();

		// When
		OAuth2AuthenticatedExtPrincipal result = userWithEmptyUsername.decryptUsername();
	...
	void test_decryptChain_allFieldsEncrypted_returnsFullyDecrypted() throws Exception {
		...
		OAuth2AuthenticatedExtPrincipal user = OAuth2AuthenticatedExtPrincipal.builder()
			.id(1L)
		...
		// When
		OAuth2AuthenticatedExtPrincipal decrypted = user.decryptUsername().decryptMail().decryptMobile();
