 ...
 */
@ReadingConverter
public final class BytesToOAuth2AuthorizationRequestConverter
		implements Converter<byte @NonNull [], OAuth2AuthorizationRequest> {
	...
	@Override
	public OAuth2AuthorizationRequest convert(byte @NonNull [] value) {
