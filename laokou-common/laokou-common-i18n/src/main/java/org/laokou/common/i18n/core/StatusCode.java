...
/**
 * 状态码 不包括 200、400、401、403、404、500 编码由5位数字构成 前2位为应用编号 后3位为业务编号 gateway => 1 auth => 2
 * admin => 3 tenant => 4 sentinel => 5 sms => 6
 *
 * @author laokou
 */
public interface StatusCode {
	...
	/**
	 * auth => 2 账号已被锁定，请联系管理员
	 */
	int USERNAME_DISABLE = 2006;

	/**
	 * auth => 2 帐户或密码错误，请重新输入
	 */
	int USERNAME_PASSWORD_ERROR = 2007;

	/**
	 * auth => 2 用户没有权限访问，请联系管理员
	 */
