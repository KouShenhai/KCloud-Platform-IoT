@echo off
REM Nacos Cluster Mode - Node 2
REM Copyright (c) 2022-2026 KCloud-Platform-IoT Author or Authors. All Rights Reserved.

title Nacos Cluster Node 2

chcp 65001 > nul

set NACOS_CONSOLE_PORT=8058
set NACOS_SERVER_PORT=8858
set NACOS_MCP_REGISTRY_PORT=9081
set NACOS_DEPLOYMENT_TYPE=merged
set NACOS_LOG_PATH=./logs/nacos-node2
set NACOS_HOME=%~dp0/logs/nacos-node2
...
echo.
echo ========================================
echo   Nacos Cluster Node 2 Starting...
echo ========================================
