...
--
  ...
  首先，感谢各位小伙伴们对本项目的关注。
  其次，感谢各位小伙伴对本项目做出的贡献，无论是大佬的赞助，还是小伙伴提交的代码，又或是提交的issue和改进的意见，都值得作者说一声，谢谢！因为有你们，这个项目变得越来越好~
  最后，感谢各大开源社区的开源项目，作者再次说声，谢谢！
...
--
  光阴荏苒，日月如梭，不知不觉四年过去，还记得刚到公司实习，写代码比较慢，而且经常写一些重复的代码，我那时候就在想，能不能把这部分代码记录一下，后面可以直接复制粘贴，提供工作效率？
  因此，本项目就诞生啦！
--
...
--
  ...
  2021.06 ~ 2022.06   => Spring Cloud + Apollo + Consul
  2022.06 ~ 2022.12   => Spring Cloud + Spring Cloud Tencent
  2023.02 ~ 至今       => Spring Cloud + Spring Cloud Alibaba
--
