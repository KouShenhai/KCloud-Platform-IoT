...
docker pull --platform linux/arm64 镜像名称:标签

# 容器文件复制到本地
docker cp 容器id:文件名 本地目录 => docker cp xz2wxdf:/app/test.txt /home/a/

# 本地文件复制到容器
docker cp 文件名 容器id:容器目录 => docker cp /home/a/test.txt xz2wxdf:/app/
```
