...
http  {
	...
	# ====================
	# Gateway Microservice Cluster
	# ====================
	upstream gateway_microservice_cluster {
	...
	# ====================
	# Auth Microservice Cluster
	# ====================
	upstream auth_microservice_cluster {
    ...
    server  {
        ...
        location /api-gateway {
            proxy_pass http://gateway_microservice_cluster;
	...
	server {
		...
		location /api {
			proxy_pass http://auth_microservice_cluster;
			proxy_http_version 1.1;
