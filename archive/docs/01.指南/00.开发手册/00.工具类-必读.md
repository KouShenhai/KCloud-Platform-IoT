...
// 字符串参数转为map参数
MapUtil.getParameterMap(String params);

// map转字符串
MapUtil.parseParamterString(Map<String, String> paramMap, boolean isEncode);

// map转为字符串
MapUtil.parseParamterString(Map<String, String> paramMap);

// 请求对象构建MultiValueMap
MapUtil.getParameterMap(Map<String, String[]> parameterMap);
