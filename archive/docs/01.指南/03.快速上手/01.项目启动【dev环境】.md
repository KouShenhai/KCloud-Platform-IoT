...
services:
  ...
  sentinel-dashboard:
    image: registry.cn-shenzhen.aliyuncs.com/koushenhai/sentinel-dashboard:3.5.4
...
🚀 <font color="red">注意：请运行laokou-nacos、laokou-oss、laokou-distributed-identifier、laokou-auth、laokou-gateway、laokou-admin【有先后顺序，请按照步骤】</font>
