...
🚀 升级Spring Framework版本到7.0.1

🚀 升级Spring Security版本到7.0.0

🚀 升级Spring Data版本到2025.1.0

🚀 升级Spring Cloud版本到2025.1.0

🚀 升级Spring Cloud Alibaba版本到2025.1.0.0

🚀 升级Elasticsearch至9.2.1

🚀 升级Jackson至3.0.3

###### 重构

🚀 重构laokou-network模块，单个节点单个管理，去中心化【tcp/http/udp/mqtt】

🚀 增加@Builder，强制遵循类的单一职责，只允许扩展，不对外提供修改
...
🚀 升级Spring Boot版本到3.5.7

🚀 升级Spring OAuth2 Authorization Server版本到1.5.3

🚀 升级Spring Cloud Alibaba版本到2023.0.3.3

🚀 Fory升级到0.12.3

🚀 升级Elasticsearch至9.2.0，不兼容Elasticsearch8【已移除Elasticsearch8】

🚀 升级Nacos至3.1.0

🚀 支持JDK25，使用JDK21，请切换JDK版本
...
🚀 实现监听Nacos路由变更，自动刷新多节点Gateway动态路由，无需重启服务

🚀 基于Spring-Data-Repository重构security模块，SAS暂不支持响应式，无法扩展响应式API

🚀 增加testcontainers测试数据库【已集成Postgresql/Elasticsearch/Nacos/Starrocks/MinIO/FTP】

🚀 增加基于Nacos注册的MCP Server【异步】和MCP Client【同步】

🚀 增加SpotBug插件，减少代码漏洞

###### 移除变更

🚀 移除GraalVM-JS，改为Java插件方式，方便二次开发

🚀 替换Undertow为Tomcat，为SpringBoot4准备

🚀 依赖版本限制，JDK版本限制，Maven版本限制，依赖简化，系统环境变量简化
...
🚀 日志跟踪ID改为Elasticsearch自动生成，提高系统吞吐量

🚀 部门去掉Path字段，数据权限从5种改为3种【全部/自选权限/仅本人】

###### 修复BUG

🚀 Redis响应式和阻塞式依赖传递问题，导致项目无法启动

🚀 Knife4j 4.5.0无法打开API文档

🚀 Fory不兼容Arch Linux aarch64【不兼容走jdk默认序列化】
