...
export async function getByIdV3(
  ...
  return request<API.Result>(`/v3/product-categorys/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function exportV3(
  ...
  return request<any>('/v3/product-categorys/export', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function importV3(body: {}, file?: File[], options?: { [key: string]: any }) {
  ...
  return request<any>('/v3/product-categorys/import', {
    method: 'POST',
    data: formData,
    requestType: 'form',
    ...(options || {}),
...
export async function pageV3(body: API.ProductCategoryPageQry, options?: { [key: string]: any }) {
  return request<API.Result>('/v3/product-categorys/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
