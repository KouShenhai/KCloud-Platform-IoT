...
export async function saveProductCategory(
	body: API.ProductCategorySaveCmd,
	requestId: string,
	options?: { [key: string]: any },
) {
	return request<any>('/api-proxy/iot/api/v1/product-categorys', {
...
export async function importProductCategory(
	body: {},
	file?: File[],
	options?: { [key: string]: any },
) {
...
export async function pageProductCategory(
...
export async function listTreeProductCategory(
	body: any,
	options?: { [key: string]: any },
) {
