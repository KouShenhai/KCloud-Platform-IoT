...
export async function modifyThingModel(
...
export async function saveThingModel(
	body: API.ThingModelSaveCmd,
	requestId: string,
	options?: { [key: string]: any },
) {
	return request<any>('/apis/iot/api/v1/thing-models', {
...
export async function removeThingModel(
	body: number[],
	options?: { [key: string]: any },
) {
	return request<any>('/apis/iot/api/v1/thing-models', {
...
export async function importThingModel(
	body: {},
	file?: File[],
	options?: { [key: string]: any },
) {
...
export async function pageThingModel(
